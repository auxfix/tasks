...
// 10. Unit tests
//  - Jest(jest.fn() - мокирует неопределенные функции, jest.spyOn()? - мокирует существующие)
...
//   - Покрытие(какое у вас, какое должно быть?)
// 11. Linters/Sonar/Prettier
// - любимые конфиги
...
// 17. Dev\Ops:  Jenkins, Docker, Kubernetes
// - Какой у вас DevOps процесс пайплайн.
// Node:
...
// 20. Идеальное соотношение фичи\техдолг